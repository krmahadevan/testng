...
public class ClassImpl implements IClass {
  ...
  private IdentifiableObject m_defaultInstance = null;
  private final IAnnotationFinder m_annotationFinder;
  private final List<IdentifiableObject> identifiableObjects = Lists.newArrayList();
  private final Map<Class<?>, IClass> m_classes;
  private long[] m_instanceHashCodes;
  private final IdentifiableObject m_instance;
  ...
  public ClassImpl(
    ...
    if (IdentifiableObject.unwrap(instance) instanceof ITest) {
  ...
  private IdentifiableObject getDefaultInstance(boolean create, String errMsgPrefix) {
    if (m_defaultInstance == null) {
      if (m_instance != null) {
        ...
        if (raw != null) {
          m_defaultInstance = new IdentifiableObject(raw);
        }
      }
    }
